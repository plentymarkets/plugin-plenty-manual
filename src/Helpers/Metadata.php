	...
	[
		...
		"children" => 		[
			...
			[
				...
				"navAlias" => "",
				"linkListInto" => "Welcome to the topic Setting up OTTO. The following information is available:",
				"children" => [],
				"hasChildren" => false
			],
			[
				...
				"level" => 2,
				"title" => "Setting up PIXmania",
				"keywords" => "",
				"description" => "Multi-Channel in plentymarkets: Set up the interface to the market PIXmania in your plentymarkets system.",
				"navAlias" => "",
				"linkListInto" => "Welcome to the topic Setting up PIXmania. The following information is available:",
				"children" => [],
				"hasChildren" => false
			],
			[
